        ...
        private static StartingClass Hunter()
        {
            return new StartingClass(
                ...
                abilities: new List<ClassAbility>
                {
                    ...
                    new ClassAbility("Pathfinder", "Activate to reveal the trails of all nearby creatures. For 60 seconds, glowing golden markers appear on the ground leading from your position toward every creature within 100m, refreshing as you and they move. The trails make tracking prey through dense forest or over hills trivial, and reveal hidden enemies before they can ambush you. 10 minute cooldown.", false, 0)
                }
            );
        }
