    ...
    public static class ClassDefinitions
    {
        ...
        private static StartingClass Assassin()
        {
            return new StartingClass(
                ...
                abilities: new List<ClassAbility>
                {
                    ...
                    new ClassAbility("Marked by Fate", "Activate to continuously reveal all enemies within 50m for 10 minutes. Every nearby creature is bathed in a red glow and tracked on your minimap, visible through terrain and darkness. New enemies entering range are automatically detected. Marks expire when the duration ends or targets move beyond 100m. 10 minute cooldown.", false, 0),
                    new ClassAbility("Shadow Step", "Your practiced footwork lets you move through stealth with unnatural speed. Sneak movement speed is increased by 25% and stamina drain while sneaking is reduced by 25%, allowing you to reposition for the perfect strike without exhausting yourself.", true, 0),
                    new ClassAbility("Nature's Shroud", "The wilderness becomes your greatest disguise. While crouched within 4m of bushes, shrubs, or undergrowth, your stealth factor is boosted by 80%, making you virtually invisible to nearby enemies even at close range.", true, 0),
                    new ClassAbility("Ghost Stride", "You run with a supernatural lightness that barely disturbs the air. Noise produced while running is reduced by 70%, letting you sprint at full speed without alerting enemies that would normally hear your approach from a distance.", true, 0),
                    new ClassAbility("Blade Dance", "Activate to enter a state of deadly focus. For 1 minute, all knife and dagger attacks deal double damage (2x multiplier). After the frenzy ends, you need 10 minutes to recover before activating it again. 10 minute cooldown.", false, 0)
                }
            );
        }
        ...
        private static StartingClass Hunter()
        {
            return new StartingClass(
                ...
                abilities: new List<ClassAbility>
                {
                    new ClassAbility("Predator's Mark", "Your expertise as a hunter means every strike finds the weakest point. All damage you deal to creatures is increased by 15%, as your understanding of animal anatomy and movement patterns reveals vulnerabilities that others would miss entirely. This applies to every weapon and every attack — bow, spear, axe, or bare fists — making you a universally deadlier combatant against the beasts of Valheim.", true, 0),
                    new ClassAbility("Hunter's Instinct", "Activate to continuously reveal all enemies within 50m for 10 minutes. Every nearby creature is bathed in an orange glow and tracked on your minimap, visible through terrain and darkness. New enemies entering range are automatically detected. Marks expire when the duration ends or targets move beyond 100m. 10 minute cooldown.", false, 0),
                    new ClassAbility("Keen Eye", "Years of hunting with bow and spear have trained your eye to track movement and predict where a target will be at the moment of impact. Damage dealt with bows and spears is increased by 15%, rewarding the ranged combat style that defines a true hunter. This bonus stacks with Predator's Mark against creatures, making your ranged attacks devastatingly effective against the wildlife and monsters of Valheim.", true, 0),
                    new ClassAbility("Survivalist", "A lifetime spent outdoors in every season and every weather has hardened your body and sharpened your instincts. While outdoors you move 10% faster, your stride lengthened by years of covering vast distances on foot. In the familiar biomes of meadows and black forest, your stamina regeneration is boosted by 15%, the comfortable terrain putting your body at ease and allowing faster recovery between bursts of effort.", true, 0),
                    new ClassAbility("Thick Hide", "Countless encounters with wild animals have taught you to read their attacks and roll with the impact rather than bracing against it. You take 15% less damage from creature attacks, a reflexive toughness born from surviving ambushes, charges, and maulings that would have killed a less experienced hunter. This protection applies to all non-player, non-boss creature damage, from wolf bites to greydwarf clubs.", true, 0),
                    new ClassAbility("Pathfinder", "Activate to reveal the trails of all nearby wildlife. For 60 seconds, glowing red markers appear on the ground leading from your position toward every wild animal within 100m — boar, deer, lox, neck, wolves, and more. The trails update constantly as you move, vanishing behind you and stretching ahead toward your quarry. Tracking prey through dense forest or over hills becomes trivial. 10 minute cooldown.", false, 0)
                }
            );
        }
