    ...
    public static class ClassDefinitions
    {
        ...
        private static StartingClass Assassin()
        {
            return new StartingClass(
                ...
                abilities: new List<ClassAbility>
                {
                    new ClassAbility("Killing Edge", "Your instinct for finding weak points makes every ambush lethal. Backstab damage is increased by 20% (1.2x multiplier applied to the backstab bonus). You also start with +10 Sneak and +5 Knives from your past life as a blade in the dark.", true, 0, persistenceIndex: 0),
                    new ClassAbility("Shadow Step", "Your practiced footwork lets you move through stealth with unnatural speed. Sneak movement speed is increased by 25% and stamina drain while sneaking is reduced by 25%, allowing you to reposition for the perfect strike without exhausting yourself.", true, 1, persistenceIndex: 2),
                    new ClassAbility("Nature's Shroud", "The wilderness becomes your greatest disguise. While crouched within 4m of bushes, shrubs, or undergrowth, your stealth factor is boosted by 80%, making you virtually invisible to nearby enemies even at close range.", true, 1, persistenceIndex: 3),
                    new ClassAbility("Ghost Stride", "You run with a supernatural lightness that barely disturbs the air. Noise produced while running is reduced by 70%, letting you sprint at full speed without alerting enemies that would normally hear your approach from a distance.", true, 1, persistenceIndex: 4)
                }
            );
        }
